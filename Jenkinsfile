...
pipeline {
        ...
        steps{
           nexusArtifactUploader(
              ...
              artifacts: [
                  [artifactId: 'webapp',
                  classifier: '',
                  file: '/var/lib/jenkins/workspace/jenkins-complete-cicd-pipeline/webapp/target/webapp.war', /*"${WORKSPACE}/webapp/target/webapp.war",*/
                  type: 'war']
              ]
           )
        }
  ...
  post {
    always {
        ...
        slackSend channel: 'pg-cicd-pipeline-alerts', //update and provide your channel name
